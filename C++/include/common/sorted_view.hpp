...
namespace sketch {
    ...
    public:
        ...
        void insert(u32_const_iter first, u32_const_iter last, 
                           u32 weight);
        ...
        void insert(u32 value, u32 weight);
        ...
        u32 rank(u32 item, bool inclusive = true) const;
        
        /// @brief Estimate normalized rank of a given item.
        /// @param item Item to be ranked.
        /// @param inclusive If the item is included in the rank.
        f64 nomRank(u32 item, bool inclusive = true) const;
        ...
        u32 quantile(f64 nom_rank, bool inclusive = true) const;
